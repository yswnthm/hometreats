...
const items: MenuItem[] = [
  { id: '1', name: 'Fudge Lasagne', scentProfile: 'Molten layers', price: '8.00', heatLevel: 'rich', image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?q=80&w=1089&auto=format&fit=crop' },
  { id: '2', name: 'Salted Cookie', scentProfile: 'Crisp edges', price: '4.50', heatLevel: 'warm', image: 'https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e?q=80&w=987&auto=format&fit=crop' },
  { id: '3', name: 'Lemon Tea Cake', scentProfile: 'Zest & steam', price: '6.00', heatLevel: 'sweet', image: 'https://images.unsplash.com/photo-1519340333755-56e9c1d04579?q=80&w=2070&auto=format&fit=crop' },
  { id: '4', name: 'Warm Pita', scentProfile: 'Yeast & fire', price: '5.00', heatLevel: 'warm', image: 'https://images.unsplash.com/photo-1573145464010-3574c3d4f3ca?q=80&w=988&auto=format&fit=crop' },
  { id: '5', name: 'Berry Jam', scentProfile: 'Reduction', price: '9.00', heatLevel: 'sweet', image: 'https://images.unsplash.com/photo-1605291242337-b67484df7c8d?q=80&w=987&auto=format&fit=crop' },
];
