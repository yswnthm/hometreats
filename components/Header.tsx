    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-8 items-center font-mono text-xs uppercase tracking-widest text-espresso/70">
            <a href="#" className="hover:text-burntsugar transition-colors">Spectrum</a>
            <a href="#" className="hover:text-burntsugar transition-colors">Lab Data</a>
            <a href="#" className="hover:text-burntsugar transition-colors">Journal</a>
        </nav>
